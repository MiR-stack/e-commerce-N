...
const defaultRoutes = [
  ...
  { path: DEFAULT_PATHS.REGISTER, exact: true, protected: true, component: Register },
  { path: DEFAULT_PATHS.FORGOT_PASSWORD, exact: true, publicOnly: true, component: ForgotPassword },
